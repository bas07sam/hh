document.addEventListener("DOMContentLoaded", async function () {
    ...
    submitName.addEventListener("click", function () {
        ...
        if (name.trim() !== "") {
            ...
            ctx.font = scale * 3 + "em sans-serif"; // تغيير الخط هنا
            ...
            ctx.shadowOffsetY = 2;
            ctx.shadowBlur = 4;
            ctx.fillText(name, canvas.width / 2, canvas.height * 0.8);
    ...
    saveCard.addEventListener("click", function () {
        if (name !== "") {
            ...
            ctx.fillText(name, (canvas.width - textWidth) / 2, canvas.height * 0.8);
            cardImage.src = canvas.toDataURL("image/png");
